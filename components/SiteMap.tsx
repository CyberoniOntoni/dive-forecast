...
function createLeafletMap(L: LeafletLib) {
  function MapCanvas({ siteGlances, draft, adding, onPick, onOpen }: MapProps) {
    ...
    useEffect(() => {
      ...
      markersRef.current = siteGlances.map(({ site, glance }) => {
